...
AllRestaurants(restaurantName: "Soft Swerve", restaurantStockPhoto: "softswerve", category: "Ice Cream", subcategory: "", restaurantImage: "softswervetn", borough: "Manhattan", neighborhood: "LES", address: "85B Allen St", description: "Soft Swerve has revolutionized the way people think about soft serve ice cream"),
...
AllRestaurants(restaurantName: "Milk & Cream Cereal Bar", restaurantStockPhoto: "milkandcream", category: "Ice Cream", subcategory: "milkandcream", restaurantImage: "milkandcreamtn", borough: "Manhattan", neighborhood: "Chinatown", address: "159 Mott St", description: "Milk & Cream Cereal Bar is a modern spin on a timeless favorite. A place where the old reconnects with the new and we strive to bring back your fondest memories and to help create new ones. We serve nostalgia in every bite with an endless combination of your favorite cereals!"),
